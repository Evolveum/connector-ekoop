 ...
 * @author gpalos
 */
public class EKoopFilterTranslator extends AbstractFilterTranslator<EkoopIKFilter> {
    private static final Log LOG = Log.getLog(EKoopFilterTranslator.class);

    @Override
    protected EkoopIKFilter createEqualsExpression(EqualsFilter filter, boolean not) {
